...
source_folder = Path(r'...\PrebioticDatabase\Demo_files')
target_folder = Path(r'...\Demo_files\Results')
...
# As the fial part of the setup, variables to be passed to methods downstream in the workflow are created:
