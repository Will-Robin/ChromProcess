...
ChromProcess is a library of Python code which can be used to build automated
chromatography data analysis workflows.
...
*text* format file, the code can be found in `Loading/chromatogram/text`, and
so on.
